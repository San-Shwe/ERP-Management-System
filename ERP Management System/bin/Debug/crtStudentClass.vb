...
Public Class crtStudentClass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_Management_System.crtStudentClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtStudentClass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtStudentClass = New crtStudentClass
        rpt.Site = Me.Site
        Return rpt
    End Function
