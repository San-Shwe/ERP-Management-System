...
Public Class crtParentsClass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_Management_System.crtParentsClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtParentsClass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtParentsClass = New crtParentsClass
        rpt.Site = Me.Site
        Return rpt
    End Function
